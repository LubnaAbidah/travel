...
<a href="index.php?form=7&a=detail&id=<?php echo $baris['id_pesan']; ?>&mem=<?php echo $baris['id_member']; ?>"class="btn btn-default btn-sm">Detail</a>   
  </td>
  </tr>
  <?php
   $i++;  
...
<a href="index.php?form=7&a=reset" class="btn btn-primary btn-sm">Kembali</a>
<br>
