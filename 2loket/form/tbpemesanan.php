<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Pemesanan Belum Bayar</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Tabel Pemesanan Belum Bayar</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
<a href="index.php?form=3&a=detail&id=<?php echo $baris['id_pesan']; ?>&mem=<?php echo $baris['id_member']; ?>"class="btn btn-default btn-sm">Detail</a>   
  </td>
  </tr>
  <?php
   $i++;  
...
<a href="index.php?form=3&a=reset" class="btn btn-primary btn-sm">Kembali</a>
<br>
