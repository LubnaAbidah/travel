...
?>
  ...
  <td>
  <a href="index.php?form=4&a=edit&id=<?php echo $baris['id_member']; ?>"class="btn btn-warning btn-sm"><i class="fa fa-edit"></i>UPDATE</a>	
  <a href="index.php?form=4&a=hapus&id=<?php echo $baris['id_member']; ?>"class="btn btn-danger btn-sm"><i class="fa fa-trash"></i>DELETE</a>	
  </td>
  </tr>
  <?php
   $i++;  
