...
switch ($a) {
    ...
    case "detail"  :  curd_delete($id_pesan,$id_member); break;   
...
?>
  ...
  <td>
  <!--<a href="index.php?form=2&a=edit&id=<?php //echo $baris['id_pesan']; ?>"class="btn btn-warning btn-sm"><i class="fa fa-edit"></i>UPDATE</a>
   exspot_to_pdf
   <a href="#index.php?form=3&a=detail&id=<?php //echo $baris['id_pesan']; ?>"class="btn btn-primary btn-sm">Lihat Tiket</a>  -->
   <a href="./form/exspot_to_pdf.php?mem=<?php echo $baris['id_member']; ?>&mes=<?php echo $baris['id_pesan']; ?>"class="btn btn-primary btn-sm">Lihat Tiket</a> 
  <a href="index.php?form=2&a=detail&id=<?php echo $baris['id_pesan']; ?>&mem=<?php echo $baris['id_member']; ?>"class="btn btn-default btn-sm">Detail</a>  
  </td>
  </tr>
  <?php
   $i++;  
...
<?php 
function curd_delete($id_pesan,$id_member) 
{
global $kdb;
...
<a href="index.php?form=2&a=reset" class="btn btn-primary btn-sm">Kembali</a>
<br>
<form action="index.php?form=2&a=reset" method="post">
