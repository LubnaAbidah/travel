<?php
	...
	$cek_email = mysqli_num_rows(mysqli_query($kdb, "SELECT user FROM operator_loket WHERE user = '$email'"));
	...
	
	{
    	...
    	$query = mysqli_query($kdb, "update operator_loket set password = '$password_baru' where user = '$_POST[email]'");
