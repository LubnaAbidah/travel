...
{ 
  ...
  $i=1;
  ?>
  <!--<a href="index.php?form=11&a=tambah"class="btn btn-success btn-sm"><i class="fa fa-plus"></i> CREATE</a><br>-->
  Jumlah Record :		
<?php 
 global $kdb;
 $per_hal=10;
 $jum  = "SELECT count(*) as total from konfirmasi_pesan, pesan where konfirmasi_pesan.id_pesan=pesan.id_pesan and status='Lunas'";		  
...
?>
  ...
  <td>
  <a href="index.php?form=11&a=edit&id=<?php echo $baris['no_resi']; ?>"class="btn btn-warning btn-sm"></i>Update</a>

<!--<a href="index.php?form=11&a=detail&id=<?php// echo $baris['id_pesan']; ?>&mem=<?php echo $baris['id_member']; ?>"class="btn btn-default btn-sm">Detail</a>   -->
  </td>
  </tr>
  <?php
   $i++;  
 ...
 <ul class="pagination">			
			...
			for($i=1;$i<=$banyakHalaman;$i++){
				...
				?>
				<li><a href="index.php?form=11&page=<?php echo $i ?>"><?php echo $i ?></a></li>
				<?php	
...
<a href="index.php?form=11&a=reset" class="btn btn-danger btn-sm">Batal</a>
<br>
<form action="index.php?form=11&a=reset" method="post">
