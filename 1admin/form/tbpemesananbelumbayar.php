        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Tabel Pemesanan Baru</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
<?php 
 global $kdb;
 $per_hal=10;
 $jum  = "select count(id_pesan) from pesan where status='Belum Bayar'";       
...
?>
  ...
  <td>
 <a href="index.php?form=13&a=hapus&id=<?php echo $baris['id_pesan']; ?>"class="btn btn-danger">DELETE</a> 
<a href="index.php?form=13&a=detail&id=<?php echo $baris['id_pesan']; ?>&mem=<?php echo $baris['id_member']; ?>"class="btn btn-default">DETAIL</a>   
  </td>
  </tr>
  <?php
   $i++;  
  ...
  <ul class="pagination">     
      ...
      for($i=1;$i<=$banyakHalaman;$i++){
        ...
        ?>
        <li><a href="index.php?form=13&page=<?php echo $i ?>"><?php echo $i ?></a></li>
        <?php 
...
<a href="index.php?form=13&a=reset" class="btn btn-primary btn-sm">Kembali</a>
<br>
...
$sql = " select * from pesan, jadwal, kota_asal, kota_tujuan, member where 
...
{
  global $kdb;
$sql =  "select * from member, pesan, jadwal, kota_asal, kota_tujuan, kendaraan where 
...
kota_asal.id_kota_asal and jadwal.id_kota_tujuan = kota_tujuan.id_kota_tujuan" ; 
