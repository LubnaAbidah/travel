<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Pemesanan Dalam Proses</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Tabel Pemesanan Dalam Proses</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
switch ($a) {
    ...
    case "hapus"  :  curd_delete($id_pesan,$id_member); break;   	
...
<?php 
 global $kdb;
 $per_hal=10;
 $jum  = "select count(id_pesan) from pesan where status='Dalam Proses'";       
...
<a href="index.php?form=14&a=detail&id=<?php echo $baris['id_pesan']; ?>&mem=<?php echo $baris['id_member']; ?>"class="btn btn-default">DETAIL</a>   
  </td>
  </tr>
  <?php
   $i++;  
  ...
  <ul class="pagination">     
      ...
      for($i=1;$i<=$banyakHalaman;$i++){
        ...
        ?>
        <li><a href="index.php?form=14&page=<?php echo $i ?>"><?php echo $i ?></a></li>
        <?php 
...
<a href="index.php?form=14&a=reset" class="btn btn-primary btn-sm">Kembali</a>
<br>
<form action="index.php?form=14&a=reset" method="post">
